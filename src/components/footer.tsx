        ...
        <section className="relative bg-blue-900 bg-cover bg-center">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-6 md:space-y-0 md:space-x-6">
                    <div className="text-white">
                        <ul className="space-y-2 list-disc pl-5">
                            ...
                            <li className="hover:text-red-500 cabin-small mb-2">Préstamo Personal</li>
                            <li className="hover:text-red-500 cabin-small mb-2">Préstamo Hipotecario</li>
                            <li className="hover:text-red-500 cabin-small mb-2">Préstamo Prendario</li>
                            <li className="hover:text-red-500 cabin-small mb-2">Financiamiento Automotriz</li>
                            <li className="hover:text-red-500 cabin-small mb-2">Simulador de préstamo</li>
                        </ul>
                    </div>
                    <div className="text-white">
                        <ul className="space-y-2 list-disc pl-5">
                            <li className="cabin-mediado text-xl font-semibold list-none mb-4">Inversiones</li>
                            <li className="hover:text-red-500 cabin-small mb-2">Quiero prestar</li>
                            <li className="hover:text-red-500 cabin-small mb-2">¿Cómo funciona?</li>
                            <li className="hover:text-red-500 cabin-small mb-2">Preguntas frecuentes</li>
                            <li className="hover:text-red-500 cabin-small mb-2">Dónde invertir</li>
                            <li className="hover:text-red-500 cabin-small mb-2">Simulador de inversiones</li>
                        </ul>
                    </div>
                    <div className="text-white">
                        <ul className="space-y-2 list-disc pl-5">
                            <li className="cabin-mediado text-xl font-semibold list-none mb-4">Páginas</li>
                            <li className="hover:text-red-500 cabin-small mb-2">Nosotros</li>
                            <li className="hover:text-red-500 cabin-small mb-2">Servicios</li>
                            <li className="hover:text-red-500 cabin-small mb-2">Blog</li>
                            <li className="hover:text-red-500 cabin-small mb-2">Contacto</li>
                        </ul>
                    </div>
                    <div className="text-white flex flex-col items-start space-y-2">
                        <p className="cabin-mediado text-xl font-semibold">Síguenos</p>

                        <div className="cabin-small flex items-center space-x-2">
            ...
            <span className="block text-sm sm:text-center text-gray-400">
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center">
                    <div className=" cabin-small flex-1 mb-4 sm:mb-0">
                        <p>Todos los derechos reservados © Bankok Dominicana, SRL</p>
                    </div>
                    <div className="cabin-small flex-1 flex flex-col sm:flex-row sm:justify-center space-y-2 sm:space-y-0 sm:space-x-4 px-4 sm:px-0">
