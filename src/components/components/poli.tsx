    ...
    return (
        <div>
            ...
            <p className="text-aonik-1 text-sm md:text-base leading-relaxed">
                ...
                Esta Política de Privacidad ha sido elaborada y se mantiene de acuerdo con todas las leyes y reglamentos federales e internacionales aplicables y, específicamente, con la Ley No. 172-13 (ley de protección de datos personales de Republica Dominicana).
                <br /><br />
                Los datos personales de los usuarios que se recogen y tratan a través del sitio web <b className="text-orange-500">www.bankok.com </b> Estarán bajo la responsabilidad y a cargo de: <strong>BANKOK DOMINICANA, SRL</strong>. En lo sucesivo, se denominará Consultoría Legal de Inmigración.
            </p>
        </div>
    );
}