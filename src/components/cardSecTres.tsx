    ...
    return (
        <div className={`p-4 border-b border-b-gray-400 transition-all duration-300 mb-6`}>
            <div className="flex items-center justify-between">
                <h5 className="text-aonik-3 text-2xl font-bold tracking-tight text-white">
                    {tittle}
                </h5>
                <button
            ...
            <div
                className={`text-aonik-3 mt-2 text-lg font-normal lg:text-xl text-white transition-all duration-300 overflow-hidden ${isOpen ? 'max-h-[200px]' : 'max-h-0'}`}
            >
                {description}
            </div>
        </div>
